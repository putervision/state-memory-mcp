# Project Instructions Template (.gemini/instructions.md)

Copy this file to `.gemini/instructions.md` in any repository where you want agents to automatically use `state-graph-mcp`.
